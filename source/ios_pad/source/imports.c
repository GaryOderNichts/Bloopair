...
int (*const UCWriteSysConfig)(int handle, uint32_t num, UCSysConfig_t* configs) = (void*) 0x11f80210;
int (*const UCReadSysConfig)(int handle, uint32_t num, UCSysConfig_t* configs) = (void*) 0x11f804e0;
int (*const UCDeleteSysConfig)(int handle, uint32_t num, UCSysConfig_t* configs) = (void*) 0x11f807a8;
int (*const UCOpen)(void) = (void*) 0x11f8093c;
int (*const UCClose)(int handle) = (void*) 0x11f80938;
...
bt_db_t* bt_db = (bt_db_t*) 0x12157778;
